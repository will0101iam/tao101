      ...
      <header className="sticky top-0 z-50 bg-black/90 backdrop-blur-sm">
        <div className="mx-auto flex max-w-[1520px] items-center justify-between px-6 py-5">
          <Link to="/" className="flex-shrink-0">
            <img 
              src="https://thedankoe.com/wp-content/uploads/2022/04/logo-white.png" 
              alt="Logo" 
          ...
          <div className="grid md:grid-cols-2 gap-16 mb-20">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-[23px] h-[23px] flex items-center justify-center transition-colors text-[#e8e8e8]/65 hover:text-white">
